...
PB_5_TOPIC = "powerball_5"
PB_5_TOPIC_TEST = "powerball_5_test"
SUBMIT_BET_5_TOPIC = "submit_bet_5_test"
ACCESS_LOG_TOPIC = "access_log_test"

class SbucksKafkaManager:
    def __init__(self):
    ...
    def publish_message(self, topic, msg=None, key=None):
        print(f'send message key: {key}, msg[{msg}]')
